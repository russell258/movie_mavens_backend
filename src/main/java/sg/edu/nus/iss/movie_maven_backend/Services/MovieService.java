...
public class MovieService {
    ...
    public String getMovies(@PathVariable String firstPath, @PathVariable String secondPath, @PathVariable(required=false) String thirdPath, @RequestParam("path") String page){
